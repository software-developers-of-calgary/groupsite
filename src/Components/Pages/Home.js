    ...
    return (
      <div className="home-wrapper home-background">
        ...
        <div className="home-content">
          <h2> Welcome </h2>
          <p><i>I was recently at a meetup in another city where a bunch of
          current/new Software Developers would get together and work on
          projects, or walk through tutorials together. It was useful. When one person didn't know something, often someone
          else did. It was just a helpful way to learn and grow as a software
          developer. <br></br>Simon - January 26, 2019</i></p><p>
          I wanted to get this started as a regular thing in Calgary,
